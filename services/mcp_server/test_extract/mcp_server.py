...
class ARCAMCPServer:
    ...
    def __init__(self):
        ...
        self.mcp_server = MCPServer("arca-reasoning-hub")
        ...
        async def handle_list_tools() -> ListToolsResult:
            ...
            tools = [
                ...
                Tool(
                    ...
                    description="Execute comprehensive Docker operations for container management and deployment",
                    inputSchema={
                        "type": "object",
                        "properties": {
                            "operation": {
                                "type": "string",
                                "enum": ["build", "push", "pull", "run", "stop", "remove", "logs", "exec", "inspect", "ps", "images", "system_df", "buildx_build", "buildx_push", "deploy_to_remote"],
                            ...
                            "platforms": {"type": "array", "items": {"type": "string"}, "description": "Target platforms for multi-platform builds", "default": ["linux/amd64", "linux/arm64"]},
                            "remote_host": {"type": "string", "description": "Remote host for deployment (e.g., workhorse IP)"},
                            "build_context": {"type": "string", "description": "Build context path", "default": "."},
