...
# Import the definitive conformal lift from the physics engine
from services.physics_engine.cga_lift import conformal_lift_numpy

logger = logging.getLogger(__name__)

# ── Path defaults ────────────────────────────────────────────────────────────
_MODULE_ROOT = Path(__file__).resolve().parent
_DEFAULT_BRIDGE_WEIGHTS_PATH = _MODULE_ROOT / "kinematic_bridge_c2.npz"
