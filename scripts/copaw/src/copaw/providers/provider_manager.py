...
GOOGLE_MODELS: List[ModelInfo] = [
    ModelInfo(id="gemini-3.1-flash-lite-preview", name="Gemini 3.1 Flash Lite"),
]
...
# DO NOT REMOVE: Required for Claws (Flash Lite) fallback agent UI.
PROVIDER_GOOGLE = OpenAIProvider(
    id="google",
    name="Google",
...
class ProviderManager:
    ...
    def _init_builtins(self):
        ...
        self._add_builtin(PROVIDER_GOOGLE)
