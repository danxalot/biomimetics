...
koyeb app update $APP_NAME     --docker $IMAGE_NAME:auth     --env API_KEY=""     --env GITHUB_TOKEN="REPLACED_WITH_SECRET_FETCHER"     --env PORT="8080"     --ports 8080:http     --instance-type nano     --regions fra
